...
var (
	todoDBTypes = map[string]string{`ID`: `bigint`, `Title`: `varchar`, `Description`: `text`, `Status`: `tinyint`, `Deadline`: `timestamp`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `Deleted`: `tinyint`}
	_           = bytes.MinRead
)
