...
var (
	todoAllColumns            = []string{"id", "title", "description", "status", "deadline", "created_at", "updated_at", "deleted"}
	todoColumnsWithoutDefault = []string{"title", "description", "deadline"}
	todoColumnsWithDefault    = []string{"id", "status", "created_at", "updated_at", "deleted"}
